...
Como podemos apreciar el servidor que mas rápido ha sido es Ubuntu, por muy poca diferencia seguido de CentOS y finalmente Windows Server, con la misma configuración en todas las maquinas.
...
\begin{enumerate}
	...
	\begin{figure}[H] %con el [H] le obligamos a situar aquí la figura
		\centering
		\includegraphics[scale=0.3]{pics/1}  %el parámetro scale permite agrandar o achicar la imagen. En el nombre de archivo puede especificar directorios
		\caption{Descarga jmeter} \label{fig:jmt1}
	\end{figure}

	\begin{figure}[H] %con el [H] le obligamos a situar aquí la figura
	\centering
	\includegraphics[scale=0.3]{pics/2}  %el parámetro scale permite agrandar o achicar la imagen. En el nombre de archivo puede especificar directorios
	...
	\begin{figure}[H] %con el [H] le obligamos a situar aquí la figura
		\centering
		\includegraphics[scale=0.3]{pics/3}  %el parámetro scale permite agrandar o achicar la imagen. En el nombre de archivo puede especificar directorios
		\caption{Descomprimiendo jmeter 3} \label{fig:jmt3}
	\end{figure}

	\begin{figure}[H] %con el [H] le obligamos a situar aquí la figura
		\centering
		\includegraphics[scale=0.3]{pics/4}  %el parámetro scale permite agrandar o achicar la imagen. En el nombre de archivo puede especificar directorios
...
\begin{enumerate}
	...
	\begin{figure}[H] %con el [H] le obligamos a situar aquí la figura
		\centering
		\includegraphics[scale=0.3]{pics/5}  %el parámetro scale permite agrandar o achicar la imagen. En el nombre de archivo puede especificar directorios
	...
	\begin{figure}[H] %con el [H] le obligamos a situar aquí la figura
		\centering
		\includegraphics[scale=0.3]{pics/6}  %el parámetro scale permite agrandar o achicar la imagen. En el nombre de archivo puede especificar directorios
...
\begin{figure}[H] %con el [H] le obligamos a situar aquí la figura
	\centering
	\includegraphics[scale=0.3]{pics/7}  %el parámetro scale permite agrandar o achicar la imagen. En el nombre de archivo puede especificar directorios
	\caption{Ejecutando jmeter 7} \label{fig:jmt7}
\end{figure}

\item Ahora tenemos que configurar las peticiones http, debemos hacer este paso para cada uno de los servidores con su respectiva ip y su index.html.

\begin{figure}[H] %con el [H] le obligamos a situar aquí la figura
	\centering
	\includegraphics[scale=0.3]{pics/8}  %el parámetro scale permite agrandar o achicar la imagen. En el nombre de archivo puede especificar directorios
	\caption{Ejecutando jmeter 8} \label{fig:jmt8}
\end{figure}

\item Ahora tenemos que añadir como obtendremos los resultados de cada una de las peticiones anteriores que hemos declarado.

\begin{figure}[H] %con el [H] le obligamos a situar aquí la figura
	\centering
	\includegraphics[scale=0.3]{pics/9}  %el parámetro scale permite agrandar o achicar la imagen. En el nombre de archivo puede especificar directorios
	\caption{Ejecutando jmeter 9} \label{fig:jmt9}
\end{figure}

\item Nos debe quedar así.

\begin{figure}[H] %con el [H] le obligamos a situar aquí la figura
	\centering
	\includegraphics[scale=0.3]{pics/10}  %el parámetro scale permite agrandar o achicar la imagen. En el nombre de archivo puede especificar directorios
	\caption{Ejecutando jmeter 10} \label{fig:jmt10}
\end{figure}
...
\begin{enumerate}
	...
	\begin{figure}[H] %con el [H] le obligamos a situar aquí la figura
		\centering
		\includegraphics[scale=0.3]{pics/11}  %el parámetro scale permite agrandar o achicar la imagen. En el nombre de archivo puede especificar directorios
	...
	\begin{figure}[H] %con el [H] le obligamos a situar aquí la figura
		\centering
		\includegraphics[scale=0.3]{pics/12}  %el parámetro scale permite agrandar o achicar la imagen. En el nombre de archivo puede especificar directorios
	...
	\begin{figure}[H] %con el [H] le obligamos a situar aquí la figura
		\centering
		\includegraphics[scale=0.3]{pics/13}  %el parámetro scale permite agrandar o achicar la imagen. En el nombre de archivo puede especificar directorios
	...
	\begin{figure}[H] %con el [H] le obligamos a situar aquí la figura
		\centering
		\includegraphics[scale=0.3]{pics/14}  %el parámetro scale permite agrandar o achicar la imagen. En el nombre de archivo puede especificar directorios
...
\lstinputlisting[language=Python]{benchmark.py}
...
\begin{figure}[H] %con el [H] le obligamos a situar aquí la figura
	\centering
	\includegraphics[scale=0.4]{pics/anfitrion}  %el parámetro scale permite agrandar o achicar la imagen. En el nombre de archivo puede especificar directorios
...
\begin{figure}[H] %con el [H] le obligamos a situar aquí la figura
	\centering
	\includegraphics[scale=0.4]{pics/virtual}  %el parámetro scale permite agrandar o achicar la imagen. En el nombre de archivo puede especificar directorios
